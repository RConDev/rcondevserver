namespace RConDevServer.Protocol.Dice.Battlefield3.CommandHandler.Vars
{
    ...
    public class VarsTeamKillValueDecreaseCommandHandler 
        : VarsCommandHandlerBase<VarsTeamKillValueDecreasePerSecondCommand, int?>
    {
        public override string Command
        {
            get { return Constants.COMMAND_VARS_TEAM_KILL_VALUE_DECREASE; }
        }

...
{
    public class VarsTeamKillValueDecreaseCommandHandler : VarsCommandHandlerBase
    {
        public override string Command
        {
            get { return RConDevServer.Protocol.Dice.Battlefield3.Constants.COMMAND_VARS_TEAM_KILL_VALUE_DECREASE; }
        }

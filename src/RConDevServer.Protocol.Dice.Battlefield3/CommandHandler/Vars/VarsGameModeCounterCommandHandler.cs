...
{
    public class VarsGameModeCounterCommandHandler : VarsCommandHandlerBase
    {
        public override string Command
        {
            get { return RConDevServer.Protocol.Dice.Battlefield3.Constants.COMMAND_VARS_GAME_MODE_COUNTER; }
        }

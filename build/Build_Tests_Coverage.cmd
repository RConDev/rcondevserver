...
tools\OpenCover.4.0.804\OpenCover.Console.exe -target:"tools\nunit-console\bin\nunit-console-x86.exe" -targetdir:..\_Artifacts\Tests\ -targetargs:"RConDevServer.Core.Tests.dll" -register:user "tools\OpenCover.4.0.804\x86\OpenCover.Profiler.dll" -output:"..\_Artifacts\reports\coverage.xml" -filter:"+[RConDevServer*]*"
